                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="/admin/update" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" type="text" id="example-hf-email" name="number" value="${user.number}" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="example-hf-phone">班级</label>
                                <div class="col-md-7">
                                    <input class="form-control" type="text"  id="example-hf-phone" name="classid" value="${user.classid}" >
                                </div>
                            </div>
                            </c:forEach>
                            <div class="form-group">
