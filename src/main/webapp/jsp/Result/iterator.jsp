...
<head>
    ...
    <link href="${ctx}/static/bower_components/morrisjs/morris.css" rel="stylesheet">
            ...
            <div class="row bar">
                ...
                <div id="blog-post" class="col-md-9">
                    <section class="post">
                        ...
                        <div class="image" style="max-width: 90%;"><img src="${ctx}/static/img/iterator.png"  class="img-fluid"></div>
                    </section>
                </div>
                <div class="col-md-3" >
