...
<head>
    ...
    <style type="text/css">
        .page1{
            background: url("${ctx}/static/img/display1.png") no-repeat ;
            background-size: 100% 100%;
        }
        .page2{
            background: url("${ctx}/static/img/display2.png") no-repeat ;
            background-size: 100% 100%;
        }
        .page3{
           background:  url("${ctx}/static/img/display3.png") no-repeat;
            background-size: 100% 100%;
        }
    </style>
</head>
