...
<%--    <!--[if lt IE 9]>--%>
    ...
    <style type="text/css">
        .page1{
            background: url("${ctx}/static/img/display6.jpg") no-repeat ;
            background-size: 100% 100%;
        }
        .page2{
            background: url("${ctx}/static/img/display4.jpg") no-repeat ;
            background-size: 100% 100%;
        }
        .page3{
            background:  url("${ctx}/static/img/display5.jpg") no-repeat;
            background-size: 100% 100%;
        }
    </style>
</head>
