...
<div id="all">
                ...
                <c:if test="${empty sessionScope.user}">
                    <div id="navigation" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <!-- ========== Contact dropdown ==================-->
                            <li class="nav-item dropdown"><a href="${ctx}/jsp/admin/login.jsp"  class="dropdown-toggle">简介<b class="caret"></b></a>
                            </li>
                            <li class="nav-item dropdown "><a href="${ctx}/jsp/admin/login.jsp" class="nav-link">矩阵输入</a>
                            </li>
                            <li class="nav-item dropdown menu-large"><a href="${ctx}/jsp/admin/login.jsp#" data-toggle="dropdown" class="dropdown-toggle">单步演示<b class="caret"></b></a>

                                <!-- ========== FULL WIDTH MEGAMENU ==================-->
                            <li class="nav-item dropdown ">
                                <a href="${ctx}/jsp/admin/login.jsp" data-hover="dropdown" data-delay="200" class="check-toggle">总结分析<b class="caret"></b></a>
                            </li>
                        </ul>
                    </div>
                ...
                <c:if test="${not empty sessionScope.user}">
                    <div id="navigation" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <!-- ========== Contact dropdown ==================-->
                            <li class="nav-item dropdown">
                                <a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">简介 <b class="caret"></b></a>
                            ...
                            <li class="nav-item dropdown "><a href="${ctx}/jsp/contact.jsp" class="nav-link">矩阵输入</a>
                            </li>
                            <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">一步演示<b class="caret"></b></a>
                            ...
                            <!-- ========== FULL WIDTH MEGAMENU ==================-->
                            <li class="nav-item dropdown "><a href="${ctx}/jsp/analysis.jsp" data-hover="dropdown" data-delay="200" class="check-toggle">总结分析 <b class="caret"></b></a>
                        </ul>
                    </div>
                    <div id="search" class="collapse clearfix">
                        <form role="search" class="navbar-form">
    ...
    <section style="background: url('static/img/sx1.jpg') center center repeat; background-size: cover;" class="bar background-white relative-positioned">
        <div class="container">
            <!-- Carousel Start-->
